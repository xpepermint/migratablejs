...
ava_1["default"].serial("method `perform` runs seed operations", function (t) { return __awaiter(_this, void 0, void 0, function () {
    var count, seeder, index;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                count = 0;
                seeder = new src_1.Seeder({ ctx: { val: 1 } });
                seeder.add({
                    index: 1,
                    perform: function (ctx) { return count = count + ctx.val; }
                });
                seeder.add({
                    index: 3,
                    perform: function (ctx) { return count = count + ctx.val; }
                });
                return [4, seeder.perform()];
            case 1:
                index = _a.sent();
                t.is(count, 2);
                t.is(index, 3);
